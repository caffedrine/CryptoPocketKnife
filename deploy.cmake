...
IF(CMAKE_BUILD_TYPE MATCHES Release)
    ...
    if (WIN32)
        ...
        add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory "${CMAKE_CURRENT_SOURCE_DIR}/data" "${CMAKE_BINARY_DIR}/../Deploy/Windows/data" COMMENT "Copy additional data")

        # Copy required DLLs to deploy folder
        get_target_property(QT_QMAKE_EXECUTABLE Qt${QT_VERSION_MAJOR}::qmake IMPORTED_LOCATION)
        get_filename_component(QT_WINDEPLOYQT_EXECUTABLE ${QT_QMAKE_EXECUTABLE} PATH)
        set(QT_WINDEPLOYQT_EXECUTABLE "${QT_WINDEPLOYQT_EXECUTABLE}/windeployqt.exe")
        add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD COMMAND ${QT_WINDEPLOYQT_EXECUTABLE} --no-translations --release --qmldir ${CMAKE_SOURCE_DIR}/../Deployed "${CMAKE_BINARY_DIR}/../Deploy/Windows/${PROJECT_NAME}.exe")
    endif(WIN32)
