...
# Include AES-CMAC
list(APPEND THIRD_PARTY_INCLUDES ${CMAKE_CURRENT_LIST_DIR}/aes_cmac)
list(APPEND THIRD_PARTY_SRC ${CMAKE_CURRENT_LIST_DIR}/aes_cmac/*.c ${CMAKE_CURRENT_LIST_DIR}/aes_cmac/*.cpp)
