  ...
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void))
{
  ...
  if (retVal == actOK)
  {
    ...
    else
    {
      ...
      resultCompareInputX = actBNCompare(r, wksp->baseData.Curve.n_field.m, n_length, FALSE); /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
      resultCompareInputY = actBNCompare(s, wksp->baseData.Curve.n_field.m, n_length, FALSE); /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
      ...
      else
      {
        ...
        resultCompareInputX = actBNCompare(Q.x, wksp->baseData.Curve.p_field.m, p_length, FALSE); /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
        resultCompareInputY = actBNCompare(Q.y, wksp->baseData.Curve.p_field.m, p_length, FALSE); /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
  ...
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void))
{
  ...
  else
  {
    ...
    resultCompareDN = actBNCompare(d, wksp->baseData.Curve.n_field.m, n_length, TRUE); /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
