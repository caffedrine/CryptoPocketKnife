  ...
  VSECPRIM_P2VAR_PARA(eslt_Byte) key)
{
  ...
  else
  {
    ...
    actRETURNCODE retValAct = actKDFX963_SHA512_Derive(&workSpace->wsKDFX963SHA512, secret, secretLength, info, infoLength, key, keyLength, workSpace->header.watchdog); /* SBSW_VSECPRIM_FCT_CALL_PASSED_BUFFER */
