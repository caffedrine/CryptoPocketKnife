  ...
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void))
{
  ...
  if (actBNCompare(a, b, length, FALSE) == actCOMPARE_SMALLER) /* SBSW_VSECPRIM_CALL_FUNCTION */
  {
  ...
  else
  {
    ...
    if (actBNCompare(c, Ring->m, length, FALSE) >= actCOMPARE_EQUAL) /* SBSW_VSECPRIM_CALL_FUNCTION */
    {
