  ...
  const actU8  pad1)
{
  ...
  if (((2u * strength) % actHASH_SHA3_LANE) == 0u)
  {
    ...
    info->phase = (actU8)(info->phase & (~KECCAKc_PHASE)); /* SBSW_VSECPRIM_WRITE_POINTER */
  ...
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void))
{
  ...
  if ((info->phase & KECCAKc_PHASE) != KECCAKc_PHASE_SQUEEZE)
  {
    ...
    while(len > 0u) /* FETA_VSECPRIM_ACTKECCACKF_ABSORB_SQUEEZE_WHILE_LOOP */
    {
  ...
  VSECPRIM_P2FUNC(VSECPRIM_NONE, void, watchdog)(void))
{
  ...
  if ((digestSize % 8u) == 0u)
  {
    ...
    while (size > 0u) /* FETA_VSECPRIM_ACTKECCACKF_ABSORB_SQUEEZE_WHILE_LOOP */
    {
