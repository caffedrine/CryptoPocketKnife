...
VSECPRIM_FUNC(eslt_ErrorCode) esl_initSHA1(VSECPRIM_P2VAR_PARA(eslt_WorkSpaceSHA1) workSpace)
{
  ...
  else if ((retVal = esl_CheckWorkSpaceHeader(&workSpace->header, ESL_MINSIZEOF_WS_SHA1)) != ESL_ERC_NO_ERROR) /* PRQA S 3326 */ /* MD_VSECPRIM_13.1 */ /* SBSW_VSECPRIM_CALL_FUNCTION */
  {
    /* retVal already set */
  }
  else
  {
    /* Init actCLib SHA-1 */
    (void)actSHAInit(&workSpace->wsSHA1); /* SBSW_VSECPRIM_CALL_FUNCTION */
    esl_SetWorkspaceStatus(&workSpace->header, ESL_WST_ALGO_SHA1); /* SBSW_VSECPRIM_CALL_FUNCTION */
  }
...
VSECPRIM_FUNC(eslt_ErrorCode) esl_updateSHA1(
  VSECPRIM_P2VAR_PARA(eslt_WorkSpaceSHA1) workSpace, /* PRQA S 3673 */ /* MD_VSECPRIM_16.7 */
  ...
  VSECPRIM_P2CONST_PARA(eslt_Byte) input)
{
  ...
  else if ((retVal = esl_CheckWorkSpaceHeaderAndState(&workSpace->header, ESL_MAXSIZEOF_WS_SHA1, ESL_WST_ALGO_SHA1)) != ESL_ERC_NO_ERROR) /* PRQA S 3326 */ /* MD_VSECPRIM_13.1 */ /* SBSW_VSECPRIM_FCT_CALL_P2CONST_PARAM */
  {
  ...
  else
  {
    ...
    actRETURNCODE result = actSHAUpdate(&workSpace->wsSHA1, /* SBSW_VSECPRIM_CALL_FUNCTION */
...
VSECPRIM_FUNC(eslt_ErrorCode) esl_finalizeSHA1(VSECPRIM_P2VAR_PARA(eslt_WorkSpaceSHA1) workSpace, VSECPRIM_P2VAR_PARA(eslt_Byte) messageDigest)
{
  ...
  else
  {
    ...
    esl_ResetAndClearWorkspace(&workSpace->header, &workSpace->wsSHA1); /* PRQA S 0315 */ /* MD_VSECPRIM_P2VOID_CAST */ /* SBSW_VSECPRIM_CALL_FUNCTION */
  }
