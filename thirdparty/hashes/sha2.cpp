...
void SHA512_224::transform(const unsigned char *message, unsigned int block_nb)
{
    uint64 w[80];
    uint64 wv[8];
    uint64 t1, t2;
...
{
    m_h[0] = 0x8C3D37C819544DA2ULL;
    m_h[1] = 0x73E1996689DCD4D6ULL;
    m_h[2] = 0x1DFAB7AE32FF9C82ULL;
    m_h[3] = 0x679DD514582F9FCFULL;
    m_h[4] = 0x0F6D2B697BD44DA8ULL;
    m_h[5] = 0x77E36F7304C48942ULL;
    m_h[6] = 0x3F9D85A86A1D36C8ULL;
    m_h[7] = 0x1112E6AD91D692A1ULL;
    m_len = 0;
    m_tot_len = 0;
}

void SHA512_224::update(const unsigned char *message, unsigned int len)
{
    unsigned int block_nb;
    unsigned int new_len, rem_len, tmp_len;
    const unsigned char *shifted_message;
...
void SHA512_224::final(unsigned char *digest)
{
    unsigned int block_nb;
    unsigned int pm_len;
    unsigned int len_b;
