...
Encoding::Encoding(QWidget *parent): QWidget(parent), ui(new Ui::Encoding)
{
    ui->setupUi(this);
...
/*   ______                     _ _
    ...
    |______|_| |_|\___\___/ \__,_|_|_| |_|\__, |
                                          ...
                                          |___/
*/
void Encoding::EncodeDecode_General_UpdateAllFieldsFromQByteArray(QByteArray bytes, const QString& exception)
{
...
void Encoding::on_textEdit_EncodeDecode_General_Ascii_textChanged()
{
...
void Encoding::on_textEdit_EncodeDecode_General_HEX_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag)
        return;
...
void Encoding::on_textEdit_EncodeDecode_General_BIN_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag)
        return;
...
void Encoding::on_textEdit_EncodeDecode_General_Base64_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag)
        return;
...
void Encoding::on_textEdit_EncodeDecode_General_AlphanumericStrings_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag )
        return;
...
void Encoding::on_textEdit_EncodeDecode_General_DEC_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag )
        return;
...
void Encoding::on_textEdit_EncodeDecode_General_Number_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag )
        return;
...
void Encoding::on_pushButton_EncodeDecode_General_ClearAll_clicked()
{
...
void Encoding::on_pushButton_EncodeDecode_General_LoadBinary_clicked()
{
...
void Encoding::on_textEdit_EncodeDecode_UrlEncoded_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag )
        return;
...
void Encoding::on_textEdit_EncodeDecode_UrlDecoded_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag )
        return;
...
void Encoding::on_textEdit_EncodeDecode_HtmlEncoded_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag )
        return;
...
void Encoding::on_textEdit_EncodeDecode_HtmlDecoded_textChanged()
{
    // Skip updating the other boxes to prevent a infinite loop updates
    if(BypassOnChangeEventFlag )
        return;
