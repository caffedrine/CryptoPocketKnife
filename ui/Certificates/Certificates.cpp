...
// You may need to build the project (run Qt uic code generator) to get "ui_Certificates.h" resolved
...
#include "ui_Certificates.h"
#include "utils.h"

Certificates::Certificates(QWidget *parent) :
        QWidget(parent), ui(new Ui::Certificates)
{
    ui->setupUi(this);
...
void Certificates::Status_EndWithError(QString err_msg)
{
    qCritical().nospace().noquote() << "ERROR: " + err_msg;
}

void Certificates::Status_EndWithSuccess(QString err_msg)
{
    qDebug().nospace().noquote() << "SUCCESS: " + err_msg;
}

void Certificates::Status_Clear()
{
...
*/
QString Certificates::ParseCertCsrInputStringToB64(QString input)
{
...
void Certificates::on_textEdit_certificates_Parse_InputCertificate_textChanged()
{
    this->ParseCert();
}

void Certificates::on_pushButton_certificates_Parse_ParseCertificate_clicked()
{
    this->ParseCert();
}

void Certificates::on_pushButton_certificates_Parse_ParseCSR_clicked()
{
    this->ParseCSR();
}

void Certificates::on_textEdit_certificates_ParseCsr_InputCsr_textChanged()
{
    // Clear message box
    this->Status_Clear();
    this->ParseCSR();
...
void Certificates::on_pushButton_certificates_Parse_LoadCertificate_clicked()
{
    // Clear message box
    this->Status_Clear();
...
void Certificates::on_pushButton_certificates_Parse_LoadCSR_clicked()
{
    // Clear message box
    this->Status_Clear();
...
void Certificates::on_pushButton_certificates_Parse_CopyCertHEX_clicked()
{
    QString output = "";
...
void Certificates::on_pushButton_certificates_Parse_CopyCSRHEX_clicked()
{
    QString output = "";
    // Loop through each byte from array and append it to output
...
void Certificates::on_pushButton_certificates_Parse_ExportCSR_clicked()
{
...
void Certificates::on_pushButton_certificates_Parse_ExportCRT_clicked()
{
    QString fileName = QFileDialog::getSaveFileName(this, tr("Save File"),
                                                    "certificate.crt",
...
void Certificates::OnCertFileDragged(QString fileName)
{
    this->ui->textEdit_certificates_Parse_InputCertificate->setText(ParseCertOrCsrFromFileToHexStr(fileName));
}

void Certificates::OnCsrFileDragged(QString fileName)
{
    this->ui->textEdit_certificates_ParseCsr_InputCsr->setText(ParseCertOrCsrFromFileToHexStr(fileName));
}
