...
void Web::webScraper_OnRequestStarted(QString requestId, QString requestUrl)
{
...
void Web::webScraper_OnRequestError(QString requestId, QString requestUrl, HttpResponse response)
{
...
void Web::webScraper_OnRequestFinished(QString requestId, QString requestUrl, HttpResponse response)
{
